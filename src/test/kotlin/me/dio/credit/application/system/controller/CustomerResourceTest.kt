...
class CustomerResourceTest {
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("SanderUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("ToledoUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("sander@email.com"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "SanderUpdate",
        lastName: String = "ToledoUpdate",
